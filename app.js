...
function save() {
    let id = document.getElementById('addTodoListInput').value;
...
function search() {
    let searchData = document.getElementById('filter').value.toLowerCase();
    let list = document.querySelectorAll('.todoList');
    // console.log(list);
    list.forEach(element => {
        if (element.textContent.includes(searchData)) {
